defmodule SoundboxServer.Application do
  use Application
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      worker(SoundboxServer.Normalizer, [[name: SoundboxServer.Normalizer]])
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: SoundboxServer.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    SoundboxServerWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
